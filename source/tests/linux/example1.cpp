...
//This example demonstrates how to create a window of a specific size.
int main(int argc, const char** argv)
{
    //We first create an OpenSceneGraph manager. The manager manages
    //the 3d view and the internal scene graph. We pass the starting position of the
    //window, the size, and wether or not it is full screen or not.
